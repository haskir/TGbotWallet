...
@profile_router.callback_query(StateFilter(FSMChangeSelf.FSMChangeSelfMenu))
...
@profile_router.message(StateFilter(FSMChangeSelf.FSMChangeEmail),
...
@profile_router.message(StateFilter(FSMChangeSelf.FSMChangeName), F.text.isalpha())
...
@profile_router.message(StateFilter(FSMChangeSelf.FSMChangeName))
...
@profile_router.callback_query(StateFilter(FSMChangeSelf), lambda call: "Back" in call.data)
